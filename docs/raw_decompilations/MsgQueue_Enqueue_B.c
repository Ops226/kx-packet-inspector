...
void MsgQueue_Enqueue_B(undefined4 *param_1,undefined *param_2,undefined8 *param_3,
                       undefined8 param_4,undefined8 *param_5,undefined8 *param_6,
                       undefined8 *param_7,undefined4 *param_8,undefined1 *param_9)
  ...
  *puVar3 = 0;
  ...
  while (plVar2 != (longlong *)0x0) {
    ...
    *puVar4 = 0;
    ...
    if (*plVar2 != 0) {
      (*(code *)param_2)(*plVar2,*param_3,param_4,*param_5,*param_6,*param_7,*param_8,*param_9);
    }
    if (puVar3[2] == 0) {
